...
.diff-verte { background: #2e7d32; }
.diff-bleue { background: #1565c0; }
.diff-rouge { background: #c62828; }
.diff-noire { background: #000000; }
...
<tr>
    ...
    <td>
        <span class="badge diff-<?= $piste['difficulte'] ?>">
            <?= ucfirst($piste['difficulte']) ?>
        </span>
    </td>
