...
.alerte-normal { color:green; font-weight:bold; }
.alerte-vigilance { color:orange; font-weight:bold; }
.alerte-danger { color:red; font-weight:bold; }
...
<a href="/test/page_admin//admin_pistes.php">🎿 Pistes</a>
<a href="/test/page_admin/admin_remontees.php">🚠 Remontées</a>
<a href="/test/page_admin/admin_alerte.php">⚠️Seuil d'alerte</a>
...
<?php
$classe = 'alerte-normal';
$texte  = 'Normal';

if ($alerte === 'vigilance') {
    $classe = 'alerte-vigilance';
    $texte  = 'Vigilance';
...
<script>
const API_PISTES    = '\api\alerte_live.php';
const API_REMONTEES = '\api\pistes_live.php';
